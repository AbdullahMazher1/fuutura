...
function Vision() {
    ...
    return (
        <div className="relative w-full pt-32 pb-60 flex flex-col gap-12 items-center justify-center bg-black/70">
            {/* Background GIF */}
            <div className="absolute inset-0 -z-10 flex items-center justify-center">
                <img
                    src="/Videos/Wave.gif"
                    alt="Background Animation"
                    className="w-2/3 h-2/3 object-cover mix-blend-overlay"
                    // style={{
                    //     WebkitMaskImage:
