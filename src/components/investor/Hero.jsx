    ...
    return (
        ...
        >
            ...
            <video
                ...
                muted
                playsInline
                className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-700 ${inView ? "opacity-100" : "opacity-0"
                    }`}
            />
            ...
            <motion.img
                ...
                animate={
                    inView
                        ? { opacity: 0.5, x: iconOffsets[0].x, y: iconOffsets[0].y }
                        : { opacity: 0, x: 0, y: 0 }
                }
            ...
            <motion.img
                ...
                animate={
                    inView
                        ? { opacity: 0.5, x: iconOffsets[2].x, y: iconOffsets[2].y }
                        : { opacity: 0, x: 0, y: 0 }
                }
                transition={{ duration: 0.8 }}
            />
            ...
            <motion.img
                ...
                animate={
                    inView
                        ? { opacity: 0.5, x: iconOffsets[3].x, y: iconOffsets[3].y }
                        : { opacity: 0, x: 0, y: 0 }
                }
                transition={{ duration: 0.8 }}
            />
            ...
            {/* TITLE */}
            <h2 ref={ref} className="pt-20 font-futura text-white text-[30px] md:text-[38px] font-bold mb-6 leading-tight z-10 relative">
