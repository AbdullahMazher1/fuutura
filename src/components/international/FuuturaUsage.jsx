...
const FuuturaUsage = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden text-white">
      ...
      {/* Center Vertical Beam (Replace with your glow image) */}
      <div className="absolute left-1/2 top-0 -translate-x-1/2 h-full w-[400px] pointer-events-none hidden lg:block">
        <img
          src="/beam.png" // <-- your vertical glow image
          alt="beam"
