...
function Hero() {
  return (
    <div className="relative w-full h-[600px] sm:h-[700px] lg:h-[800px] overflow-hidden">
      ...
      <div 
        className="absolute w-[90%] max-w-[600px] sm:max-w-[667px] lg:max-w-[667px] h-auto lg:h-[78px] opacity-100 z-30 left-1/2 -translate-x-1/2 top-[320px] sm:top-[360px] lg:top-[400px] px-4"
      >
        <h1 className="font-futura font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-[40px] leading-[106%] text-center align-middle capitalize text-white">
      ...
      <div 
        className="absolute w-[90%] max-w-[650px] sm:max-w-[738px] lg:max-w-[738px] h-auto lg:h-[86px] opacity-100 z-30 left-1/2 -translate-x-1/2 top-[420px] sm:top-[460px] lg:top-[500px] px-4"
      >
