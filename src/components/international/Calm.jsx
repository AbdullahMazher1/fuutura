    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-6 lg:px-0">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-12 lg:gap-16">
          ...
          >
            <h1 className="font-futura font-medium text-2xl sm:text-3xl md:text-4xl lg:text-[48px] leading-[100%] tracking-normal align-middle uppercase text-white mb-4 sm:mb-6 lg:mb-8">
