...
export const Direction = () => {
    return (
        <div className="flex flex-col md:flex-row items-center justify-center px-6 md:px-24 bg-black gap-16">
            ...
            <div className="flex flex-col gap-6 md:gap-8 max-w-xl items-center md:items-start justify-center text-center md:text-left">
