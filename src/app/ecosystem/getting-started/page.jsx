export default function GettingStartedPage() {
  return (
    <>
      ...
      <div className="relative z-10 overflow-auto min-h-[100vh] h-[90%] flex flex-col items-center justify-center text-center md:ml-[270px] px-8 py-10 md:px-12 md:py-14">
