export default function GettingStartedPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-8 py-10 md:px-12 md:py-14 text-center min-h-full bg-center bg-no-repeat bg-cover" style={{ backgroundImage: "url('/Images/first1.png')" }}>
