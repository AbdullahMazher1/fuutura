export default function GettingStartedPage() {
  return (
    <div className="flex-1 text-center h-[100vh] bg-fixed bg-center bg-no-repeat bg-cover w-full" style={{ backgroundImage: "url('/Images/first1.png')" }}>
      <div className="bg-[#000000a4] h-full w-full px-8 py-10 md:px-12 md:py-14 flex flex-col items-center justify-center">
